...
Network<Arch, Transformer>::evaluate(const Position&                         pos,
  ...
  const FeatureTransformerWeightCache<FeatureTransformerType::HalfDimensions>* ft_cache) const {
    ...
    const auto psqt       = featureTransformer->transform(pos, cache, transformedFeatures, bucket, ft_cache);
