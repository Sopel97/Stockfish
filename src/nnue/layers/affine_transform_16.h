...
#ifndef NNUE_LAYERS_AFFINE_TRANSFORM_16_H_INCLUDED
#define NNUE_LAYERS_AFFINE_TRANSFORM_16_H_INCLUDED
...
namespace Eval::NNUE::Layers {
  ...
  class AffineTransform16 {
   ...
   private:
    ...
    friend class Trainer<AffineTransform16>;
