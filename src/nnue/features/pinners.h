...
#ifndef _NNUE_FEATURES_PINNERS_H_
#define _NNUE_FEATURES_PINNERS_H_
...
namespace Eval::NNUE::Features {
    ...
    public:
        ...
        static constexpr const char* kName = "Pinners";
        // Hash value embedded in the evaluation function file
        static constexpr std::uint32_t kHashValue = 0x7123A24Bu;
