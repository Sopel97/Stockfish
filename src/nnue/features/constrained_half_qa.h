...
#ifndef NNUE_FEATURES_CONSTRAINED_HALF_QA_H_INCLUDED
#define NNUE_FEATURES_CONSTRAINED_HALF_QA_H_INCLUDED
...
namespace Eval::NNUE::Features {
    ...
    class ConstrainedHalfQA {

    public:
        // Feature name
        static constexpr const char* kName = (AssociatedKing == Side::kFriend) ?
            "ConstrainedHalfQA(Friend)" : "ConstrainedHalfQA(Enemy)";
        ...
        static constexpr IndexType kMaxActiveDimensions = 28;

        // Trigger for full calculation instead of difference calculation
        static constexpr TriggerEvent kRefreshTrigger =
            (AssociatedKing == Side::kFriend) ?
            TriggerEvent::kFriendQueenMoved : TriggerEvent::kEnemyQueenMoved;
