...
#ifndef NNUE_FEATURES_PAWN_STRUCTURE_H_INCLUDED
#define NNUE_FEATURES_PAWN_STRUCTURE_H_INCLUDED
...
namespace Eval::NNUE::Features {
    ...
    public:
        ...
        static constexpr const char* kName = (AssociatedKing == Side::kFriend) ?
            "PawnStructure(Friend)" : "PawnStructure(Enemy)";
        ...
        static constexpr IndexType kMaxActiveDimensions = 8*8;
