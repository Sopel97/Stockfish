...
#ifndef NNUE_FEATURES_HALF_KPE5_H_INCLUDED
#define NNUE_FEATURES_HALF_KPE5_H_INCLUDED
...
namespace Eval::NNUE::Features {
    ...
    // Feature HalfKPE5: Combination of the position of own king
    ...
    public:
        ...
        static constexpr const char* kName = (AssociatedKing == Side::kFriend) ?
            "HalfKPE5(Friend)" : "HalfKPE5(Enemy)";
        ...
        static constexpr IndexType kDimensions =
            static_cast<IndexType>(SQUARE_NB) * static_cast<IndexType>(PS_END) * 5;
