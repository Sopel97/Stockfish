...
#ifndef NNUE_FEATURES_HALF_KA_SPECIAL_H_INCLUDED
#define NNUE_FEATURES_HALF_KA_SPECIAL_H_INCLUDED
...
namespace Eval::NNUE::Features {
    ...
    public:
        ...
        static constexpr const char* kName = (AssociatedKing == Side::kFriend) ?
            "HalfKASpecial(Friend)" : "HalfKASpecial(Enemy)";
...
#endif // #ifndef NNUE_FEATURES_HALF_KA_SPECIAL_H_INCLUDED
