...
namespace Eval::NNUE::Features {
    ...
    inline IndexType ConstrainedHalfQA<AssociatedKing>::make_index(
        Color perspective,
        Square s,
        Piece pc,
        Square ksq) {
    ...
    template <Side AssociatedKing>
    void ConstrainedHalfQA<AssociatedKing>::append_active_indices(
        const Position& pos,
        Color perspective,
        IndexList* active) {
        ...
        auto queens = pos.pieces(c, QUEEN);
    ...
    template <Side AssociatedKing>
    void ConstrainedHalfQA<AssociatedKing>::append_changed_indices(
        const Position& pos,
        Color perspective,
        IndexList* removed,
        IndexList* added) {
    ...
    template class ConstrainedHalfQA<Side::kFriend>;
    template class ConstrainedHalfQA<Side::kEnemy>;
