...
#ifndef NNUE_FEATURES_CONSTRAINED_HALF_BA_H_INCLUDED
#define NNUE_FEATURES_CONSTRAINED_HALF_BA_H_INCLUDED
...
namespace Eval::NNUE::Features {
    ...
    class ConstrainedHalfBA {

    public:
        // Feature name
        static constexpr const char* kName = (AssociatedKing == Side::kFriend) ?
            "ConstrainedHalfBA(Friend)" : "ConstrainedHalfBA(Enemy)";
        ...
        static constexpr IndexType kMaxActiveDimensions = 13*2;

        // Trigger for full calculation instead of difference calculation
        static constexpr TriggerEvent kRefreshTrigger =
            (AssociatedKing == Side::kFriend) ?
            TriggerEvent::kFriendBishopMoved : TriggerEvent::kEnemyBishopMoved;
