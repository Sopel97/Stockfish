...
//Definition of input features HalfKAE5v2 of NNUE evaluation function

#include "half_kae5v2.h"
...
namespace Stockfish::Eval::NNUE::Features {
    ...
    inline IndexType HalfKAE5v2<AssociatedKing>::make_index(
        Color perspective,
        Square s,
        Piece pc,
        Square ksq,
    ...
    template <Side AssociatedKing>
    inline std::pair<IndexType, IndexType> HalfKAE5v2<AssociatedKing>::make_index_2(
        Color perspective,
        Square s,
        Piece pc,
        Square ksq,
        ...
        const IndexType index_base = IndexType(orient(us, s) + kpp_board_index[us][pc] + PS_END2 * ksq);
    ...
    template <Side AssociatedKing>
    void HalfKAE5v2<AssociatedKing>::AppendActiveIndices(
        const Position& pos,
        Color perspective,
        IndexList* active) {
    ...
    template <Side AssociatedKing>
    void HalfKAE5v2<AssociatedKing>::AppendChangedIndices(
        const Position& pos,
        Color perspective,
        IndexList* removed,
        IndexList* added) {
    ...
    template class HalfKAE5v2<Side::kFriend>;
