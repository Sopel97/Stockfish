...
#ifndef NNUE_FEATURES_CONSTRAINED_HALF_NA_H_INCLUDED
#define NNUE_FEATURES_CONSTRAINED_HALF_NA_H_INCLUDED
...
namespace Eval::NNUE::Features {
    ...
    class ConstrainedHalfNA {

    public:
        // Feature name
        static constexpr const char* kName = (AssociatedKing == Side::kFriend) ?
            "ConstrainedHalfNA(Friend)" : "ConstrainedHalfNA(Enemy)";
        ...
        static constexpr TriggerEvent kRefreshTrigger =
            ...
            TriggerEvent::kFriendKnightMoved : TriggerEvent::kEnemyKnightMoved;
