...
namespace Eval::NNUE::Features {
    ...
    inline IndexType ConstrainedHalfRA<AssociatedKing>::make_index(
        Color perspective,
        Square s,
        Piece pc,
        Square ksq) {
    ...
    template <Side AssociatedKing>
    void ConstrainedHalfRA<AssociatedKing>::append_active_indices(
        const Position& pos,
        Color perspective,
        IndexList* active) {
        ...
        for (int j = 0; j < 2; ++j)
        {
            ...
            Bitboard influence = PseudoAttacks[ROOK][ksq];
    ...
    template <Side AssociatedKing>
    void ConstrainedHalfRA<AssociatedKing>::append_changed_indices(
        const Position& pos,
        Color perspective,
        IndexList* removed,
        IndexList* added) {
    ...
    template class ConstrainedHalfRA<Side::kFriend>;
    template class ConstrainedHalfRA<Side::kEnemy>;
