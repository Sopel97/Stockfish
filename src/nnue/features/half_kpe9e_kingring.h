...
#ifndef NNUE_FEATURES_HALF_KPE9E_KINGRING_H_INCLUDED
#define NNUE_FEATURES_HALF_KPE9E_KINGRING_H_INCLUDED
...
namespace Eval::NNUE::Features {
    ...
    class HalfKPE9E_KingRing {

    public:
        // Feature name
        static constexpr const char* kName = (AssociatedKing == Side::kFriend) ?
            "HalfKPE9E_KingRing(Friend)" : "HalfKPE9E_KingRing(Enemy)";
        ...
        static constexpr IndexType kMaxActiveDimensions = 32 + 8;
