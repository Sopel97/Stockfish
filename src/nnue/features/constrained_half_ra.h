...
#ifndef NNUE_FEATURES_CONSTRAINED_HALF_RA_H_INCLUDED
#define NNUE_FEATURES_CONSTRAINED_HALF_RA_H_INCLUDED
...
namespace Eval::NNUE::Features {
    ...
    class ConstrainedHalfRA {

    public:
        // Feature name
        static constexpr const char* kName = (AssociatedKing == Side::kFriend) ?
            "ConstrainedHalfRA(Friend)" : "ConstrainedHalfRA(Enemy)";
        ...
        static constexpr IndexType kMaxActiveDimensions = (14+4)*2;

        // Trigger for full calculation instead of difference calculation
        static constexpr TriggerEvent kRefreshTrigger =
            (AssociatedKing == Side::kFriend) ?
            TriggerEvent::kFriendRookMoved : TriggerEvent::kEnemyRookMoved;
