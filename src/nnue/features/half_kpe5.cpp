...
namespace Eval::NNUE::Features {
    ...
    inline IndexType HalfKPE5<AssociatedKing>::make_index(
        Color perspective,
        Square s,
        Piece pc,
        Square ksq,
    ...
    template <Side AssociatedKing>
    void HalfKPE5<AssociatedKing>::append_active_indices(
        const Position& pos,
        Color perspective,
        IndexList* active) {
    ...
    template <Side AssociatedKing>
    void HalfKPE5<AssociatedKing>::append_changed_indices(
        const Position& pos,
        Color perspective,
        IndexList* removed,
        IndexList* added) {
    ...
    template class HalfKPE5<Side::kFriend>;
    template class HalfKPE5<Side::kEnemy>;
