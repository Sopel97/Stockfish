...
#ifndef NNUE_HALFKPE9E_KINGRING_256X2_32_32_H_INCLUDED
#define NNUE_HALFKPE9E_KINGRING_256X2_32_32_H_INCLUDED
...
namespace Eval::NNUE {
    ...
    using RawFeatures = Features::FeatureSet<
        Features::HalfKPE9E_KingRing<Features::Side::kFriend>>;
