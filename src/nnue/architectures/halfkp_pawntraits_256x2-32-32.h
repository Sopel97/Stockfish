...
#ifndef NNUE_HALFKP_PAWNTRAITS_256X2_32_32_H_INCLUDED
#define NNUE_HALFKP_PAWNTRAITS_256X2_32_32_H_INCLUDED
...
namespace Eval::NNUE {
    ...
    using RawExtraFeatures = Features::FeatureSet<
        Features::Pinners,
    ...
    constexpr IndexType kTransformedExtraFeatureDimensions = 64;

    namespace Layers {

        // Define network structure
        using InputLayer = InputSlice<kTransformedFeatureDimensions * 2 + kTransformedExtraFeatureDimensions * 2>;
...
#endif // #ifndef NNUE_HALFKP_PAWNTRAITS_256X2_32_32_H_INCLUDED
