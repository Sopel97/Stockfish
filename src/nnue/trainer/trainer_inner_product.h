#ifndef _NNUE_TRAINER_INNER_PRODUCT_H_
#define _NNUE_TRAINER_INNER_PRODUCT_H_
...
namespace Eval::NNUE {
    ...
    class Trainer<Layers::InnerProduct<PreviousLayer>> {
    private:
        // Type of layer to learn
        using LayerType = Layers::InnerProduct<PreviousLayer>;
    ...
    private:
        ...
        void quantize_parameters() {
            ...
            target_layer_->bias_ =
                round<typename LayerType::BiasType>(biases_[0] * kBiasScale);
        ...
        void dequantize_parameters() {
            biases_[0] = static_cast<LearnFloatType>(
                target_layer_->bias_ / kBiasScale);
        ...
        static constexpr bool kIsOutputLayer = true;
