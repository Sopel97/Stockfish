#ifndef _NNUE_TRAINER_FEATURES_FACTORIZER_HALF_KAE4_H_
#define _NNUE_TRAINER_FEATURES_FACTORIZER_HALF_KAE4_H_

#include "factorizer.h"

#include "nnue/features/half_kae4.h"

#include "factorizer_half_ka.h"

// Specialization of NNUE evaluation function feature conversion class template for HalfKAE4
namespace Eval::NNUE::Features {

    // Class template that converts input features into learning features
    // Specialization for HalfKAE4
    template <Side AssociatedKing>
    class Factorizer<HalfKAE4<AssociatedKing>> {
    private:
        using FeatureType = HalfKAE4<AssociatedKing>;
    ...
    public:
        ...
        static void append_training_features(
            ...
            IndexType index_offset = append_base_feature<FeatureType>(
                kProperties[kFeaturesHalfKAE4], base_index, training_features);
    ...
    template <Side AssociatedKing>
    constexpr FeatureProperties Factorizer<HalfKAE4<AssociatedKing>>::kProperties[];
