#ifndef _NNUE_TRAINER_FEATURES_FACTORIZER_HALF_KPE9E_H_
#define _NNUE_TRAINER_FEATURES_FACTORIZER_HALF_KPE9E_H_

#include "factorizer.h"

#include "nnue/features/half_kpe9e.h"
...
namespace Eval::NNUE::Features {
    ...
    class Factorizer<HalfKPE9E<AssociatedKing>> {
    private:
        using FeatureType = HalfKPE9E<AssociatedKing>;
    ...
    public:
        ...
        static void append_training_features(
            ...
            IndexType index_offset = append_base_feature<FeatureType>(
                kProperties[kFeaturesHalfKPE9E], base_index, training_features);
            ...
            if (our_mobility_index == 2)
            {
                ...
                append_base_feature<FeatureType>(
                    kProperties[kFeaturesHalfKPE9E], index, training_features);
            }
    ...
    template <Side AssociatedKing>
    constexpr FeatureProperties Factorizer<HalfKPE9E<AssociatedKing>>::kProperties[];
