#ifndef _NNUE_TRAINER_FEATURES_FACTORIZER_HALF_KPE5_H_
#define _NNUE_TRAINER_FEATURES_FACTORIZER_HALF_KPE5_H_

#include "factorizer.h"

#include "nnue/features/half_kpe5.h"
...
namespace Eval::NNUE::Features {
    ...
    class Factorizer<HalfKPE5<AssociatedKing>> {
    private:
        using FeatureType = HalfKPE5<AssociatedKing>;
    ...
    public:
        ...
        static void append_training_features(
            ...
            IndexType index_offset = append_base_feature<FeatureType>(
                kProperties[kFeaturesHalfKPE5], base_index, training_features);
    ...
    template <Side AssociatedKing>
    constexpr FeatureProperties Factorizer<HalfKPE5<AssociatedKing>>::kProperties[];
